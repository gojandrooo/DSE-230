...
if [ "${has_docker}" == "" ]; then
  ...
  echo "-----------------------------------------------------------------------"
  {
    docker run --rm -it --init -p 127.0.0.1:8888:8888 -p 127.0.0.1:8765:8765 -p 127.0.0.1:4040:4040 \
      -p 127.0.0.1:4041:4041 -p 127.0.0.1:8787:8787 -p 127.0.0.1:8788:8788 \
      -v "${PWD}":/home/work ${IMAGE}:${IMAGE_VERSION}
  } || {
    echo "-----------------------------------------------------------------------"
